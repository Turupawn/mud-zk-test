...
library SecretCommitment {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "SecretCommitment", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000536563726574436f6d6d69746d656e74);
